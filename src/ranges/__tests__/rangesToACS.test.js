...
describe('rangesToACS', () => {
  it('default options', () => {
    ...
    expect(acs).toBe(
      '<sup>1</sup>H NMR: δ 2.92-3.01 (3H, m), 3.35 (3H, d, <i>J</i> = 5.2 Hz, CH<sub>3</sub>OH), 4.09-4.34 (3H, 4.23 (d, <i>J</i> = 5.2 Hz), 4.15 (t, <i>J</i> = 5.5, 5.2 Hz)), 5.42-5.64 (3H, 5.46 (d, <i>J</i> = 5.2 Hz), 5.55 (dd, <i>J</i> = 5.5, 5.2 Hz)), 6.26-7.27 (8H, m).',
    );
  });
